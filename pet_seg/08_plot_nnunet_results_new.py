...
NICE_DATASET_NAMES = {
    ...
    "imagesTs_Dataset100_Bern_Quadra-SH_uExplorer-num_train=956-num_test=50_NAC-Quadra": "Bern Quadra (n = 25)",
    "imagesTs_Dataset100_Bern_Quadra-SH_uExplorer-num_train=956-num_test=50_NAC-uExplorer": "Shared uExplorer (n = 25)",
...
def plot_nnunet_test_results():
    for patient_dice_scores_path in (RESULTS_DIR / "patient_dice_scores").glob("Dataset100*internal*.csv"):
        dataset_name, trainer_name, plans_name, config, fold, test_datatets = patient_dice_scores_path.stem.split("__")
        st.write(f"# {dataset_name} - {test_datatets}")
